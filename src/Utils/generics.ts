...
export const Browsers = {
  ...
  macOS: (browser) =>
    ["Mac OS", browser, "10.15.3"] as [string, string, string],
  baileys: (browser) =>
    ["DogtorSoftware", browser, "4.0.0"] as [string, string, string],
...
export const toNumber = (t: Long | number) =>
  typeof t === "object" && "toNumber" in t ? t.toNumber() : t;

export function shallowChanges<T>(
  old: T,
  current: T,
  { lookForDeletedKeys }: { lookForDeletedKeys: boolean }
): Partial<T> {
